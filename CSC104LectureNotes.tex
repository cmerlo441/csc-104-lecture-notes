...
\input{day-nested-conditionals}
\input{day-debugging-conditionals}
...
\input{day-python1}
\input{day-errors-zylabs}
\input{day-variables-objects}
\input{day-modules}
\input{day-first-script}
\input{day-tracing-python-1.tex}
\input{day-graphics-intro}
\input{day-graphics-debugging}
\input{day-exam2}

\part{Intermediate Python Programming}

\input{day-python-conditionals}
\input{day-python-conditionals-2}
\input{day-functions}
\input{day-tracing-functions}
\input{day-validating-input}
\input{day-if-loops-graphics}
\input{day-finite-loops}
\input{day-traffic-light}
\input{day-exam3}
